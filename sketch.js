...
function preload() {
  ...
  sb = loadImage("images/SBEEnb.png");
  sbf = loadImage("images/SBEEFLIPEDnb.png");
...
function setup() {
  ...
  S = createSprite(1, windowHeight - 6, 5, 5);
  S.shapeColor = "#26619c";
  // S.debug = true;
